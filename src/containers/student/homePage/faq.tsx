            ...
            <Box sx={innerBoxStyles}>
                ...
                <List sx={listStyles}>
                    <ListItemButton onClick={() => handleClick('item1')}>
                        ...
                        <ListItemText primaryTypographyProps={{ fontSize: '1.25rem' }} primary='O que é um teste vocacional?' />
                    ...
                    <Collapse in={openItems['item1']} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <ListItemButton sx={{ pl: 4 }}>
                                ...
                                <ListItemText primaryTypographyProps={{ fontSize: '1.2rem' }} primary='Um teste vocacional é uma ferramenta que ajuda a
                    ...
                    <ListItemButton onClick={() => handleClick('item2')}>
                        ...
                        <ListItemText primaryTypographyProps={{ fontSize: '1.25rem' }} primary='Como funciona o teste vocacional?' />
                    ...
                    <Collapse in={openItems['item2']} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <ListItemButton sx={{ pl: 4 }}>
                                ...
                                <ListItemText primaryTypographyProps={{ fontSize: '1.2rem' }} primary='O teste consiste em uma série de perguntas sobre seus
                    ...
                    <ListItemButton onClick={() => handleClick('item3')}>
                        ...
                        <ListItemText primaryTypographyProps={{ fontSize: '1.25rem' }} primary='Como posso entrar em contato com uma universidade específica?' />
                    ...
                    <Collapse in={openItems['item3']} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <ListItemButton sx={{ pl: 4 }}>
                                ...
                                <ListItemText primaryTypographyProps={{ fontSize: '1.2rem' }} primary='Cada página de universidade inclui detalhes de contato,
                    ...
                    <ListItemButton onClick={() => handleClick('item4')}>
                        ...
                        <ListItemText primaryTypographyProps={{ fontSize: '1.25rem' }} primary='Como criar uma conta no site?' sx={listItemTextStyles} />
                    ...
                    <Collapse in={openItems['item4']} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <ListItemButton sx={{ pl: 4 }}>
                                ...
                                <ListItemText primaryTypographyProps={{ fontSize: '1.2rem' }} primary='Clique no botão "Cadastre-se" no centro da primeira
                    ...
                    <Collapse in={openItems['item5']} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <ListItemButton sx={{ pl: 4 }}>
                                ...
                                <ListItemText primaryTypographyProps={{ fontSize: '1.2rem' }} primary='Após criar uma conta, fazer login e realizar um
